...
in
{
  home.file.".config/niri/config.kdl".text = ''
    ...
    window-rule {
        match app-id="vrmonitor"
        open-floating true
    }

    window-rule {
        match app-id="ibus-ui-gtk3"
        open-floating true
    }
    ...
    binds {
        ...
        // Everything below here is in relatively newer versions of Niri. Comment these out if your distribution does not package this version of Niri yet.
        Mod+W { toggle-column-tabbed-display; }
        Mod+G { expand-column-to-available-width; }
        Mod+Alt+F { toggle-windowed-fullscreen; }
        ISO_Level5_Shift+A { toggle-overview; }
        Mod+T { spawn "/home/kaylie/.config/niri/cheatsheet.sh";  }
        Mod+KP_Divide { set-dynamic-cast-window;  }
        Mod+KP_Multiply { set-dynamic-cast-monitor;  }
        Mod+KP_Subtract { clear-dynamic-cast-target; }
    }
